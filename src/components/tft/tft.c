...
extern uint8_t tft_UbuntuB21[];
extern uint8_t tft_OCRAStd24[];
extern uint8_t tft_OCRAStd36[];
...
void TFT_setFont(uint8_t font, const char *font_file)
{
  ...
  if (font == FONT_7SEG) {
    ...
    cfont.color  = _fg;
	  ...
	  else if (font == UBUNTUB21_FONT) cfont.font = tft_UbuntuB21;
	  else if (font == OCRASTD24_FONT) cfont.font = tft_OCRAStd24;
	  else if (font == OCRASTD36_FONT) cfont.font = tft_OCRAStd36;
